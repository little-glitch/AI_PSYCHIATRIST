...
# When the user types their name, greet them
if name:
...
# Environment variables for CUDA (if using GPU)
os.environ['CUDA_LAUNCH_BLOCKING'] = "1"
os.environ['TORCH_USE_CUDA_DSA'] = "1"

# Page styling with Streamlit
st.set_page_config(page_title="AI Psychiatrist", page_icon="🧠", layout="wide")
...
with st.sidebar:
    st.markdown("## About AI Psychiatrist")
    st.markdown("""
        Welcome to the AI Psychiatrist app! This application is designed to provide emotional support, guidance, and advice with empathy and professionalism. 
        Whether you're feeling stressed, anxious, or just need someone to talk to, the AI Psychiatrist is here to help.
    """)
    st.markdown("---")
...
# Main content area
st.title(":green[AI Psychiatrist]")
    ...
    with st.form("user_info_form"):
        ...
        if submitted:
            ...
            st.session_state.messages.append({
                "role": "assistant",
                "content": f"Hi {name}! It's great to meet you. How can I assist you today?"
            })
            st.rerun()
